...
//        System.out.println("onNestedScroll- dxConsumed:" + dxConsumed + "; dyConsumed: " + dyConsumed + "; dxUnconsumed: " + dxUnconsumed + "; dyUnconsumed: " + dyUnconsumed);
        LogU.e("test", "dyc-(" + dyConsumed + ");dyu-(" + dyUnconsumed+")");
...
//        }
        ...
        LogU.t("r--"+child.getVisibility());
        if (((dyConsumed > 0 && dyUnconsumed == 0) || (dyConsumed == 0 && dyUnconsumed > 0)) && child.getVisibility() == View.VISIBLE && !isAnimatingOut) {// 显示
            LogU.t("hide");
